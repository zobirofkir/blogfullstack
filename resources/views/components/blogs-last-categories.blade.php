    ...
    <div class="bg-gray-900">
        <div class="flex container mx-auto md:p-10 flex-col">
            ...
            <div class="flex flex-col md:flex-row md:py-4 p-2 md:p-0 rounded">
                <a href="#" class="md:w-1/2 flex flex-col min-h-96 relative border bg-cover rounded" style="background-image: url({{asset('storage/'.$blog->images[0])}});">
                        ...
                        <div class="basis-1/2 flex flex-col">
                            <div class="p-2 flex flex-col">
                                <div class="h-56 group w-full rounded shadow relative hover:shadow-xl ease-in-out duration-300 border-2 hover:border-gray-900" style="background: url({{asset('storage/'.$blog->images[0])}}); background-size: cover;">
                                    <a href="#" class="flex flex-col text-xs font-bold text-white text-lg absolute h-full bottom-0 right-0 w-full">
